    ...
    await getD1()
      .prepare(
        `INSERT INTO products (
          ...
          badge, today_dispatch, active, sale_status, sort_order, created_at, updated_at
      ...
      .bind(
        ...
        product.todayDispatch ? 1 : 0, product.active ? 1 : 0, product.saleStatus, product.sortOrder,
      )
      .run();
